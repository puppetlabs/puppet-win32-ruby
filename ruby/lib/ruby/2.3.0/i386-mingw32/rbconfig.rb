...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--enable-bundled-libyaml' '--disable-install-doc' '--disable-install-rdoc' '--host' 'i686-unknown-mingw32' 'CPPFLAGS=-DFD_SETSIZE=2048' 'debugflags=-g' '--prefix=C:/ProgramFilesFolder/PuppetLabs/Puppet/sys/ruby' '--with-opt-dir=C:/ProgramFilesFolder/PuppetLabs/Puppet/puppet' 'host_alias=i686-unknown-mingw32' 'LDFLAGS=-LC:/tools/pl-build-tools/lib -LC:/tools/mingw32/lib -LC:/ProgramFilesFolder/PuppetLabs/Puppet/sys/ruby/lib'"
