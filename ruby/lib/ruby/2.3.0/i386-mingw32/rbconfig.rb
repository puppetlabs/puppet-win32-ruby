...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/ProgramFilesFolder/Puppet/ruby")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--enable-bundled-libyaml' '--disable-install-doc' '--disable-install-rdoc' '--host' 'i686-unknown-mingw32' 'CPPFLAGS=-DFD_SETSIZE=2048' 'debugflags=-g' '--prefix=C:/ProgramFilesFolder/Puppet/ruby' '--with-opt-dir=C:/ProgramFilesFolder/Puppet/tools' 'host_alias=i686-unknown-mingw32' 'CC=gcc -static-libgcc' 'LDFLAGS=-LC:/tools/pl-build-tools/lib -LC:/tools/mingw32/lib -LC:/ProgramFilesFolder/Puppet/ruby/lib'"
  ...
  CONFIG["debugflags"] = "-g"
  CONFIG["optflags"] = "-IC:/tools/pl-build-tools/include -IC:/tools/mingw32/include -IC:/ProgramFilesFolder/Puppet/tools/include -fno-omit-frame-pointer -fno-fast-math"
  CONFIG["NULLCMD"] = ":"
  CONFIG["DLNOBJ"] = "dln.o"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = " -Wl,--enable-auto-image-base,--enable-auto-import -LC/lib -L/ProgramFilesFolder/Puppet/tools/lib $(DEFFILE)"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-DFD_SETSIZE=2048 -IC/include -I/ProgramFilesFolder/Puppet/tools/include -D_WIN32_WINNT=0x0501 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -LC:/tools/pl-build-tools/lib -LC:/tools/mingw32/lib -LC:/ProgramFilesFolder/Puppet/ruby/lib -LC/lib -L/ProgramFilesFolder/Puppet/tools/lib"
  CONFIG["CFLAGS"] = "$(cflags)"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc -static-libgcc"
  ...
  CONFIG["target"] = "i386-unknown-mingw32"
  CONFIG["host_os"] = "mingw32"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host"] = "i686-unknown-mingw32"
  ...
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "i686-unknown-mingw32"
  CONFIG["build_alias"] = ""
