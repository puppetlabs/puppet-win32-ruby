...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--enable-bundled-libyaml' '--disable-install-doc' '--disable-install-rdoc' '--host' 'x86_64-unknown-mingw32' 'CPPFLAGS=-DFD_SETSIZE=2048' 'debugflags=-g' '--prefix=C:/ProgramFiles64Folder/PuppetLabs/Puppet/sys/ruby' '--with-opt-dir=C:/ProgramFiles64Folder/PuppetLabs/Puppet/puppet' 'host_alias=x86_64-unknown-mingw32' 'LDFLAGS=-LC:/tools/pl-build-tools/lib -LC:/tools/mingw64/lib -LC:/ProgramFiles64Folder/PuppetLabs/Puppet/sys/ruby/lib'"
