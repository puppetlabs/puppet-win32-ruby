...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/ProgramFiles64Folder/Puppet/ruby")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--enable-bundled-libyaml' '--disable-install-doc' '--disable-install-rdoc' '--host' 'x86_64-unknown-mingw32' 'CPPFLAGS=-DFD_SETSIZE=2048' 'debugflags=-g' '--prefix=C:/ProgramFiles64Folder/Puppet/ruby' '--with-opt-dir=C:/ProgramFiles64Folder/Puppet/tools' 'host_alias=x86_64-unknown-mingw32' 'CC=gcc -static-libgcc' 'LDFLAGS=-LC:/tools/pl-build-tools/lib -LC:/tools/mingw64/lib -LC:/ProgramFiles64Folder/Puppet/ruby/lib'"
  ...
  CONFIG["debugflags"] = "-g"
  CONFIG["optflags"] = "-IC:/tools/pl-build-tools/include -IC:/tools/mingw64/include -IC:/ProgramFiles64Folder/Puppet/tools/include -fno-omit-frame-pointer -fno-fast-math"
  CONFIG["NULLCMD"] = ":"
  CONFIG["DLNOBJ"] = "dln.o"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = " -Wl,--enable-auto-image-base,--enable-auto-import -LC/lib -L/ProgramFiles64Folder/Puppet/tools/lib $(DEFFILE)"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-DFD_SETSIZE=2048 -IC/include -I/ProgramFiles64Folder/Puppet/tools/include -D_WIN32_WINNT=0x0501 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -LC:/tools/pl-build-tools/lib -LC:/tools/mingw64/lib -LC:/ProgramFiles64Folder/Puppet/ruby/lib -LC/lib -L/ProgramFiles64Folder/Puppet/tools/lib"
  ...
  CONFIG["target"] = "x86_64-unknown-mingw32"
  CONFIG["host_os"] = "mingw32"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-unknown-mingw32"
  ...
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "x86_64-unknown-mingw32"
  CONFIG["build_alias"] = ""
